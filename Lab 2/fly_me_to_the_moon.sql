CREATE TABLE IF NOT EXISTS FULL_HEALTH_ANALYSIS_RESULT (
	...
	FULL_HEALTH_ANALYSIS_RESULT BOOL NOT NULL,
...
CREATE TABLE IF NOT EXISTS PASSENGER (
	...
	ANALYSIS_ID INT NOT NULL UNIQUE REFERENCES FULL_HEALTH_ANALYSIS_RESULT (ANALYSIS_ID),
	INSURANCE_ID INT NOT NULL UNIQUE REFERENCES INSURANCE (INSURANCE_ID)
);
